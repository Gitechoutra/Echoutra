...
class NotificationType:
    ...
    KYC_SUBMITTED = "KYC_SUBMITTED"   # user → admin: a request awaiting review
    ...
    CHOICES = [PRICE_ALERT, ORDER_FILLED, ORDER_CANCELLED, ORDER_REJECTED,
               DIVIDEND, NEWS_ALERT, STOCK_LISTED, KYC_SUBMITTED, KYC_APPROVED,
               KYC_REJECTED, ACCOUNT, SECURITY, SUBSCRIPTION, SYSTEM, ADMIN_MESSAGE]
